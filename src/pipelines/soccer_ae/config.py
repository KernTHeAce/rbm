...
config = {
    ...
    pcc.DATA: {
        ...
        "train_data_loader": MemoryDataSet(copy_mode="deepcopy"),
        "model": MemoryDataSet(copy_mode="deepcopy"),
        "initialized_model": MemoryDataSet(copy_mode="deepcopy"),
        "initialized_optimizer": MemoryDataSet(copy_mode="deepcopy"),
        "loaded_model": MemoryDataSet(copy_mode="deepcopy"),
        "loaded_optimizer": MemoryDataSet(copy_mode="deepcopy"),
        ...
        # "results": MemoryDataSet(copy_mode="deepcopy"),
    },
}
